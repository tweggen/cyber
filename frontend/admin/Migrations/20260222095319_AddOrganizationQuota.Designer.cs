...
namespace NotebookAdmin.Migrations
{
    ...
    [Migration("20260222095319_AddOrganizationQuota")]
    partial class AddOrganizationQuota
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NotebookAdmin.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NotebookAdmin.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NotebookAdmin.Models.UserQuota", b =>
                {
                    b.HasOne("NotebookAdmin.Models.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("NotebookAdmin.Models.UserQuota", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
